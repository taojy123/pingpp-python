...
try:
    ...
    settle_account = pingpp.SettleAccount.create(app=pingpp.app_id, user='test_user_003', **params)
    ...
    # 查询结算账号
    settle_account = pingpp.SettleAccount.retrieve(app=pingpp.app_id, user='test_user_003',
                                                   settle_account_id='320117032014485200000201')
    print('retrieve settle_account:', settle_account)
    # 删除结算账号
    settle_account = pingpp.SettleAccount.delete(app=pingpp.app_id, user='test_user_003',
                                                 settle_account_id='320117032014485200000201')
    print('delete settle_account - wx_pub:', settle_account)

    # 获取结算账号列表
    settle_account_list = pingpp.SettleAccount.list(app=pingpp.app_id, user='test_user_003')
