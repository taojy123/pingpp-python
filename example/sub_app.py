...
try:
    ...
    sub_app = pingpp.SubApp.update(app=app_id, id='app_5K8C8CHGq5SSjTKG', **params)
    print('update sub_app ', sub_app)

    # 查询子商户
    sub_app = pingpp.SubApp.retrieve(app=pingpp.app_id, id='app_jXH8WHCCSGC0GCGu')
    print('retrieve sub_app', sub_app)

    # 删除子商户
    sub_app = pingpp.SubApp.delete(app=app_id, id='app_5K8C8CHGq5SSjTKG')
